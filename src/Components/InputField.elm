...
withReadOnly : InputField { constraints | hasValue : (), needsMsg : () } msg -> InputField { constraints | hasMsg : (), hasType : (), needsDisableState : () } msg
withReadOnly (InputField constraints) =
    InputField { constraints | type_ = ReadOnly }
